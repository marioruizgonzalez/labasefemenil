...
# URL del sitio
url = "https://www.ligafemenil.mx/cancha/tablas/tablafairplay/sp/54eaca472140c4"
driver.get(url)
...
def extract_table():
    try:
        table = WebDriverWait(driver, 10).until(
            EC.presence_of_element_located((By.CLASS_NAME, "tfairppy"))
        )
...
if table_data:
    ...
    filename = f"30-FairPlay.csv".replace(" ", "_")
